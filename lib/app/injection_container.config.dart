...
import 'package:street_talk/app/cubit/internet_cubit.dart' as _i10;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i10.InternetCubit>(
        () => _i10.InternetCubit(connectivity: gh<_i11.Connectivity>()));
    ...
    gh.factory<_i18.QuizRepository>(() => _i18.QuizRepository(
        remoteDataSource: gh<_i17.QuizQuestionRetrofitDataSource>()));
    gh.factory<_i19.SituationRetrofitDataSource>(
        () => _i19.SituationRetrofitDataSource(gh<_i15.Dio>()));
    gh.factory<_i20.StreetRetrofitDataSource>(
        () => _i20.StreetRetrofitDataSource(gh<_i15.Dio>()));
    gh.factory<_i21.WelcomeGoodbyeRetrofitDataSource>(
        () => _i21.WelcomeGoodbyeRetrofitDataSource(gh<_i15.Dio>()));
    ...
    gh.factory<_i23.QuizCubit>(
        () => _i23.QuizCubit(quizRepository: gh<_i18.QuizRepository>()));
    gh.factory<_i24.SituationRepository>(() => _i24.SituationRepository(
        remoteDataSource: gh<_i19.SituationRetrofitDataSource>()));
    gh.factory<_i25.StreetRepository>(() => _i25.StreetRepository(
        remoteDataSource: gh<_i20.StreetRetrofitDataSource>()));
    gh.factory<_i26.WelcomeGoodbyeRepository>(() =>
        _i26.WelcomeGoodbyeRepository(
            welcomeGoodbyeDataSource:
                gh<_i21.WelcomeGoodbyeRetrofitDataSource>()));
    ...
    gh.factory<_i28.SituationCubit>(() => _i28.SituationCubit(
        situationRepository: gh<_i24.SituationRepository>()));
    gh.factory<_i29.StreetCubit>(
        () => _i29.StreetCubit(streetRepository: gh<_i25.StreetRepository>()));
    gh.factory<_i30.WelcomeGoodbyeCubit>(() => _i30.WelcomeGoodbyeCubit(
        welcomeGoobyeRepository: gh<_i26.WelcomeGoodbyeRepository>()));
    return this;
  }
}

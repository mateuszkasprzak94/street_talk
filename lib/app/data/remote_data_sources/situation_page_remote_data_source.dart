class SituationMockedDataSource {
  Future<List<Map<String, dynamic>>?> getSituationData() async {
    return [
      ...
      {
        'id': 4,
        'word': 'Dejar (a alguien) con el culo al aire',
      ...
      {
        'id': 8,
        'word': 'Estar manga por hombro/ estar patas arriba',
      ...
      {
        'id': 14,
        'word': 'Estar sin blanca/ estar a dos velas',
      ...
      {
        'id': 18,
        'word': 'Me cago en la leche (cagarse en la leche)',
        'word_translation':
